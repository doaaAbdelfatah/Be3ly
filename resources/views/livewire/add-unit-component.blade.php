                            ...
                            <div class="py-8 px-8 rounded-xl">
                                <form action="" class="mt-6">
                                    <div class="my-2 text-sm">
                                        <h1 class="font-sm text-xl mt-2 text-center">Add Units</h1>
                                        <label  class="block mb-2 text-sm text-gray-600 dark:text-gray-400"></label>
                                        <input type="text" wire:model="name" class="rounded-sm px-4 py-3 mt-3 focus:outline-none bg-gray-100 w-full" placeholder="Unit">
